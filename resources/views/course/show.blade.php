...
<div class="position-relative pt-8 pt-xl-11">
    <div class="position-absolute top-0 right-0 left-0 overlay overlay-custom-left d-none d-xl-block">
        <img class="img-fluid" src="{{ asset('assets/img/covers/cover-19.jpg') }}" alt="...">
    </div>
</div>
<!-- COURSE ================================================== -->
<div class="container">
                    ...
                    <div id="accordionCurriculum">
                        ...
                        <div class="border rounded shadow mb-6 overflow-hidden">
                            ...
                            <div id="Curriculumcollapse{{ $key }}" class="collapse {{ $key == 0 ? 'show' : '' }}"
                                ...
                                <div
                                    class="border-top px-5 py-4 min-height-70 d-md-flex align-items-center {{ $key % 2 == 1 ? 'bg-gray-100' : '' }}">
                                ...
                                <div class="d-md-flex align-items-center mb-5">
                                    <div class="me-auto mb-4 mb-md-0">
                                        <h5 class="mb-0">
                                            ...
                                            <span class="font-size-sm text-blue">{{ '@' . $review->user->username
                                                }}</span>
                                        </h5>
                                    </div>
                                    <div class="star-rating">
                                        <div class="rating" style="width:{{ convert_to_percent($review->rating) }}%;">
                                        </div>
                                    </div>
                                </div>
