...
<header class="navbar navbar-expand-xl navbar-light bg-white border-bottom py-2 py-xl-4">
    <div class="container-fluid">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-md bg-primary rounded py-4 mt-4"
                    ...
                    <li class="dropdown-item dropright">
                        <a class="dropdown-link" href="{{ route('courses.index') }}">
                            All Courses
                        </a>
                    </li>
                    <li class="dropdown-item dropright">
        ...
        <!-- Toggler -->
        <button
            class="navbar-toggler ms-4 ms-md-5 shadow-none bg-primary text-white icon-xs p-0 outline-0 h-40p w-40p d-flex d-xl-none place-flex-center"
